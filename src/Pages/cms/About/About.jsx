...
import aboutHeroImg from '../../img/img1.jpg';
import aboutImg from '../../img/img2.jpg';
import Testimonial from './Testimonial';
import CardImage1 from '../../img/img3.jpg';
import CardImage2 from '../../img/img4.jpg';
import CardImage3 from '../../img/img5.jpg';
...
const About = () => {
  ...
  return (
    ...
    >
        ...
        <Typography variant="h3" fontWeight="bold" style={{ color: "#fff" }} data-aos="fade-up">
        We Care About Your Health
        </Typography>
        <Typography
        variant="body1"
        sx={{ mt: 2, maxWidth: "600px", color: '#ffff', fontSize: "18px" }}
        data-aos="fade-up"
        data-aos-delay="200"
        >
        ...
        >
          ...
          <Grid item xs={12} sm={12} md={4} lg={4}>
            <Typography variant="body1" mt={2} sx={{ color: darkMode.value ? '#798189' : '#000' }}>
              ...
              The Big Oxmox advised her not to do so, because there were
              thousands of bad Commas, wild Question Marks and devious Semikoli,
              but the Little Blind Text didnot listen.
            </Typography>
          </Grid>
        </Grid>
      </Container>
